/*
TinyScreen.h - Last modified 10 February 2023
...
// 16b: BBBB BGGG GGGR RRRR (SAMD21 devices use BGR565)
...
const uint8_t RP2040TV            = 3;
const uint8_t RP2040TVMini        = 4;
const uint8_t H8Ball							= 5;
...
// RP2040TV button definitions
const uint8_t RPTV_BTN_PWR = 11;
const uint8_t RPTV_BTN_E1A = 3;
const uint8_t RPTV_BTN_E1B = 2;
const uint8_t RPTV_BTN_E2A = 25;
const uint8_t RPTV_BTN_E2B = 24;

// RP2040TV pin definitions

const uint8_t RPTV_PIN_MOSI= 6;
const uint8_t RPTV_PIN_SCLK= 7;
const uint8_t RPTV_PIN_DC  = 5;
const uint8_t RPTV_PIN_CS  = 8;
const uint8_t RPTV_PIN_RST = 4;

const uint8_t RPTVM_PIN_MOSI= 6;
const uint8_t RPTVM_PIN_SCLK= 7;
const uint8_t RPTVM_PIN_DC  = 5;
const uint8_t RPTVM_PIN_CS  = 8;
const uint8_t RPTVM_PIN_RST = 4;

const uint8_t H8B_PIN_MOSI = 6;
const uint8_t H8B_PIN_SCLK = 7;
const uint8_t H8B_PIN_CS   = 8;
const uint8_t H8B_PIN_DC   = 5;
const uint8_t H8B_PIN_RST  = 4;
// GPIO Pins
